export type Region = "NA" | "Europe" | "APAC" | "Middle East" | "LATAM" | "Africa";
export type Status = "Live" | "In-progress" | "On-request";
...
export interface PortRow {
  ...
  freshness: string;      // "≤2h" | "≤6h" | "Daily"
  notes?: string;
}

export const regionOrder: Region[] = ["NA","Europe","APAC","Middle East","LATAM","Africa"];
...
export const portsCoverage: PortRow[] = [
  // --- North America (14) ---
  { port: "Los Angeles", country: "USA", region: "NA", status: "Live", metrics:["Congestion","Dwell","Trend"], freshness:"≤2h" },
  { port: "New York / New Jersey", country: "USA", region: "NA", status: "Live", metrics:["Congestion","Trend"], freshness:"≤2h" },
  ...
  { port: "Shanghai", country: "China", region:"APAC", status:"In-progress", metrics:["Congestion","Trend"], freshness:"≤6h", notes:"Rollout wave-1" },
  { port: "Ningbo", country: "China", region:"APAC", status:"In-progress", metrics:["Congestion","Trend"], freshness:"≤6h" },
  { port: "Shenzhen", country: "China", region:"APAC", status:"In-progress", metrics:["Congestion","Trend"], freshness:"≤6h" },
  ...
  { port: "Kaohsiung", country: "Taiwan", region:"APAC", status:"On-request", metrics:["Congestion"], freshness:"Daily" },
  { port: "Colombo", country: "Sri Lanka", region:"APAC", status:"On-request", metrics:["Congestion"], freshness:"Daily" },
  { port: "Jakarta (Tanjung Priok)", country: "Indonesia", region:"APAC", status:"On-request", metrics:["Congestion"], freshness:"Daily" },
  ...
  // --- LATAM (7) ---
  { port: "Santos", country: "Brazil", region:"LATAM", status:"On-request", metrics:["Congestion","Throughput"], freshness:"≤6h" },
  ...
  // --- Africa (7) ---
  { port: "Tanger-Med", country: "Morocco", region:"Africa", status:"On-request", metrics:["Congestion"], freshness:"Daily" },
