  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-12">
      ...
      <p className="mt-2 max-w-2xl text-gray-600">
        Tiers by ports / monthly requests / history window. Annual billing = 10 months paid. Enterprise contracts supported.
      </p>
      ...
      <div className="mt-10 rounded-xl border bg-gray-50 p-6">
        <div className="text-sm text-gray-700">
          <b>Add-ons:</b> Extra port <b>$20</b>/port/mo; Extra <b>10k</b> requests <b>$5</b>; Historical backfill <b>$500</b>/port/year.
          Enterprise (SSO/SIEM, private networking, stricter SLAs): contact <a className="underline" href="mailto:sales@useportpulse.com">sales@useportpulse.com</a>.
        </div>
      </div>
    </div>
  );
