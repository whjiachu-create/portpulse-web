...
export const metadata: Metadata = {
  ...
  title: {
    default: "PortPulse — APIs for Port Operations",
    template: "%s · PortPulse",
  },
  description:
    "Unified APIs for congestion, dwell and port operations data. Get running in 5 minutes; production-ready in ~30.",
    ...
    <html lang="en" translate="no" className="notranslate">
      ...
      <body className="antialiased text-slate-900 bg-white">
        ...
        <div className="w-full text-center text-sm bg-slate-50 border-b border-slate-200 py-2">
          ...
          <a className="underline underline-offset-4 hover:text-slate-700" href="https://docs.useportpulse.com/EXAMPLES.md" target="_blank" rel="noreferrer">Read the Quickstart →</a>
          ...
          <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            <div className="flex items-center gap-6">
              <Link href="/" className="flex items-center gap-2">
                <Image src="/logos/portpulse-wordmark-light.svg" alt="PortPulse" width={112} height={24} className="h-6 w-auto" />
              </Link>
              ...
              <div className="hidden md:flex items-center gap-5">
                {NAV.map((n) =>
                  n.ext ? (
                    <a key={n.label} href={n.href} target="_blank" rel="noreferrer" className="text-sm text-slate-600 hover:text-slate-900">{n.label}</a>
                  ) : (
            ...
            <div className="hidden md:flex items-center gap-3">
              <a href="https://docs.useportpulse.com/EXAMPLES.md" target="_blank" rel="noreferrer" className="text-sm px-3 py-2 rounded-lg border border-slate-300 hover:bg-slate-50">Start free</a>
              ...
              <details className="group relative">
                ...
                <div className="absolute right-0 mt-2 w-56 rounded-xl border border-slate-200 bg-white shadow-lg p-2">
                  <div className="flex flex-col">
                    {NAV.map((n) =>
                      n.ext ? (
                        <a key={n.label} href={n.href} target="_blank" rel="noreferrer" className="px-3 py-2 rounded-lg text-sm hover:bg-slate-50">{n.label}</a>
                      ) : (
                        <Link key={n.label} href={n.href} className="px-3 py-2 rounded-lg text-sm hover:bg-slate-50">{n.label}</Link>
                      )
                    )}
                    <a href="https://docs.useportpulse.com/EXAMPLES.md" target="_blank" rel="noreferrer" className="px-3 py-2 rounded-lg text-sm hover:bg-slate-50">Start free</a>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 grid gap-6 md:grid-cols-4">
            <div>
              <div className="font-semibold mb-3">
                <Image src="/logos/portpulse-wordmark-light.svg" alt="PortPulse" width={128} height={28} className="h-7 w-auto" />
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="https://docs.useportpulse.com" target="_blank" rel="noreferrer" className="hover:underline">Docs</a></li>
                <li><a href="https://status.useportpulse.com" target="_blank" rel="noreferrer" className="hover:underline">Status</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a className="hover:underline" href="https://docs.useportpulse.com/SLA.md" target="_blank" rel="noreferrer">SLA</a></li>
                <li><a className="hover:underline" href="https://docs.useportpulse.com/ERRORS.md" target="_blank" rel="noreferrer">Errors</a></li>
              </ul>
            </div>
            <div>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              sameAs: ["https://docs.useportpulse.com", "https://status.useportpulse.com"],
              contactPoint: [
                { "@type": "ContactPoint", email: "sales@useportpulse.com", contactType: "sales" },
                { "@type": "ContactPoint", email: "support@useportpulse.com", contactType: "customer support" },
              ],
            }),
          }}
        />
